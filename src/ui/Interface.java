...
public class Interface extends JFrame {
	...
	private JPanel drawingPredictionBorderPanel, letterMakerBorderPanel, weightGridBorderPanel;
	...
	private void initializeFrame() {
		...
		int width = drawingPredictionBorderPanel.getX() + drawingPredictionBorderPanel.getWidth() + MARGIN * 2;
		int height = letterMakerBorderPanel.getY() + letterMakerBorderPanel.getHeight() + MARGIN * 3;
	...
	private void addDrawingPredictionPanel() {
		...
		drawingPredictionBorderPanel.setSize(drawingPredictionPanel.getWidth() + MARGIN, drawingPredictionPanel.getHeight() + MARGIN * 2);
		drawingPredictionBorderPanel.add(drawingPredictionPanel);
		drawingPredictionBorderPanel.setBorder(BorderFactory.createTitledBorder(panelBorder, "Handwritten Prediction"));
	...
	private void addLetterDataMaker() {
		...
		letterMakerBorderPanel.setLocation(MARGIN, drawingPredictionBorderPanel.getY() + drawingPredictionBorderPanel.getHeight() + MARGIN);
		
		letterMakerBorderPanel.setSize(letterDataMaker.getWidth() + MARGIN, letterDataMaker.getHeight() + MARGIN * 2);
		letterMakerBorderPanel.add(letterDataMaker);
		letterMakerBorderPanel.setBorder(BorderFactory.createTitledBorder(panelBorder, "Letter Maker"));
	...
	private void addWeightGrid() {
		...
		weightGrid = new WeightGrid(Constants.GRID_WIDTH, Constants.GRID_HEIGHT, drawingNetwork);
				
		int posX = letterMakerBorderPanel.getX() + letterMakerBorderPanel.getWidth() + MARGIN;
		...
		weightGridBorderPanel.setBorder(BorderFactory.createTitledBorder(panelBorder, "Weight Viewer"));
